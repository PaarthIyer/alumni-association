...
<div class="aspect-w-4 aspect-h-3 w-full overflow-hidden bg-gray-200" onclick={toggleFullscreen}>
    {#if imageUrl}
        <img src={imageUrl} alt="Loaded from Supabase" class="h-full w-full object-contain" />
    {:else}
